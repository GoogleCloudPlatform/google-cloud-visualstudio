...
namespace GoogleCloudExtensionUnitTests.Deployment
{
    ...
    public class WindowsVmDeploymentTests : ExtensionTestBase
    {
        ...
        protected override void BeforeEach()
        {
            ...
            _objectUnderTest = new WindowsVmDeployment(_processServiceMock.ToLazy());
        }
        ...
        public async Task TestPublishProjectAsync_OutputHandlerWritesToGcpOutputWindow()
        {
            ...
            const string expectedGcpWindowOutput = "Expected Gcp Output";
            _handler.Invoke(null, new OutputHandlerEventArgs(expectedGcpWindowOutput, OutputStream.None));

            Mock.Get(GcpOutputWindow.Default).Verify(ow => ow.OutputLine(expectedGcpWindowOutput));
        }
