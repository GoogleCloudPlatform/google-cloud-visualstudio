...
namespace GoogleCloudExtension.ManageAccounts
{
    ...
    {
        public ManageAccountsWindowContent() : this(new ManageAccountsViewModel()) { }

        public ManageAccountsWindowContent(ManageAccountsViewModel manageAccountsViewModel) : base(
