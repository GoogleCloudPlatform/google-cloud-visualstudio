...
namespace GoogleCloudExtension.CloudExplorer.SampleData
{
    ...
    public abstract class SampleDataBase
    {
        ...
        protected static readonly Lazy<ImageSource> ContainerIcon = new Lazy<ImageSource>(() => ResourceUtils.LoadImage(ContainerIconResourcePath));
        protected static readonly Lazy<ImageSource> InstanceIcon = new Lazy<ImageSource>(() => ResourceUtils.LoadImage(InstanceIconResourcePath));

        public IList<ButtonDefinition> Buttons { get; } = new List<ButtonDefinition>
        {
            new ButtonDefinition { Icon = ContainerIcon.Value },
            new ButtonDefinition { Icon = InstanceIcon.Value }
        };
    }
}
