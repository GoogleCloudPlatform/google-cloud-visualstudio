...
namespace GoogleCloudExtension.GitUtils.VS15
{
    internal class RegistryHelper
    {
        ...
        internal static IEnumerable<string> PokeTheRegistryForRepositoryList()
        {
        ...
        internal static string SetDefaultProjectPath(string path)
        {
            ...
            {
                Debug.WriteLine(string.Format(CultureInfo.CurrentCulture, "Error setting the create project path in the registry '{0}'", ex));
            }
            return old;
        }
    }
